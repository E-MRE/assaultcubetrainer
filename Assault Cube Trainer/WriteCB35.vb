Module Module1
    ...
    'Yapýmcý: TEKNOSEL
        ...
        'Tamamen Kendi Kodum Alýntý Yapanlara Biþey Diyemem Artýk
    'www.teknosel.wix.com/teknosel [ FORUM SIZEMIZE KAYIT OLMANIZ YETERLI ]
    'TEKNOSEL

        '       Örnek Kodlama;
        '       Me.Text = ReadPointerInteger(Oyunun Görev Yönetici Adý, &HPointer,&HOffset).ToString()
        '
        '       Me.Text = ReadPointerInteger("ac_client", &HB71A38,&H540).ToString()
        ' Eger Birden Fazla OffSet Var ise ( Büyükten Küçüge Dogru Yazýn)
        ' Yani Ilk Offset Sonda Olucak, Ondan Sonraki Offset ise, Bir önceki Offsete
        ...
        '       WritePointerInteger(Oyunun Görev Yönetici Adý,&HPointer,Value(Deger),&HOffset)
        '
